                ...
                <Box style={{display: 'flex'}}>
                    ...
                    </Box>
                    {
                        ...
                        <Box className={classes.login}>
                            ...
                            <Typography className={classes.text}>By continuing, you agree to HappyShop's Terms of Use and Privacy Policy.</Typography>
                            ...
                            <Typography className={classes.createText} onClick={() => toggleSignup()}>New to HappyShop? Create an account</Typography>
                        </Box> : 
                        <Box className={classes.login}>
